...
class VendingMachine:
    ...
    def vend(self):
        ...
        if self.price > self.money:
            ...
            self.money = 0
            return f'Here is your {self.name} and ${money_before-self.price} change.'
...
def preorder(t):
    ...
    for bran in t.branches:
        label_name += preorder(bran)
    return [t.label]+ label_name
...
def is_bst(t):
    ...
    if t.is_leaf():
        ...
        return False
    elif (t.branches[0].label > t.label or t.branches[1].label < t.label) and len(t.branches) == 2:
        return False
    else:
